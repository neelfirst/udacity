...
#        print os.path.join("../images","car-one.png")
        ...
        if self.display:
            try:
                ...
                for agent in self.env.agent_states:
                    agent._sprite = self.pygame.transform.smoothscale(self.pygame.image.load(os.path.join("/home/neelfirst/machine-learning/projects/smartcab/images", "car-{}.png".format(agent.color))), self.agent_sprite_size)
