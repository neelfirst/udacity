...
class Environment(object):
	...
	print "Minimum move count = {}".format(self.compute_dist(start,destination))
...
#        print "Environment.step(): t = {}".format(self.t)  # [debug]
        ...
        for agent in self.agent_states.iterkeys():
            agent.update(self.t)
#            agent.update(self.t, self.agent_states[agent])
		...
		print "Penalties = {}".format(self.primary_agent.get_penalty_rate())
